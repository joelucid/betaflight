...
#define DSHOT_TELEMETRY_DEADTIME     (2 * 30 + 10) // 2 * 30uS to switch lines plus 10us grace period
#endif
...
#define DSHOT_TELEMETRY_QUALITY_BUCKET_MS 100  // determines the granularity of the stats and the overal number rolling buckets
...
typedef struct {
    ...
    uint16_t dshotTelemetryDeadtime;
