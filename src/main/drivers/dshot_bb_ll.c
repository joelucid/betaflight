...
void bbSwitchToOutput(bbPort_t * bbPort)
{
    ...
    bbPort->direction = BBSHOT_DIRECTION_OUTPUT;
}
...
void bbSwitchToInput(bbPort_t *bbPort)
{
    ...
    bbPort->direction = BBSHOT_DIRECTION_INPUT;
}
#endif

void bbDMAPreconfigure(bbPort_t *bbPort, uint8_t direction)
{
    LL_DMA_InitTypeDef *dmainit = (direction == BBSHOT_DIRECTION_OUTPUT) ?  &bbPort->outputDmaInit : &bbPort->inputDmaInit;
    ...
    if (direction == BBSHOT_DIRECTION_OUTPUT) {
