...
#define BBSHOT_TELEMETRY_OVER_SAMPLE 3

#define BBSHOT_DIRECTION_OUTPUT 0
#define BBSHOT_DIRECTION_INPUT  1

#define BBSHOT_INVERTED         true
#define BBSHOT_NONINVERTED      false
...
#define MOTOR_PROSHOT1000_BUFFER_SIZE      ((MOTOR_DSHOT_FRAME_BITS / MOTOR_PROSHOT1000_BIT_PER_SYMBOL) * MOTOR_PROSHOT1000_STATE_PER_SYMBOL)
...
extern FAST_RAM_ZERO_INIT bbPort_t *gpioToMotorPort[10]; // GPIO group to bbPort mapping
...
// (Not support; ProShot requires 32 [word/nibble] * 4 [nibble] = 128 [word])
extern uint32_t bbOutputBuffer[MOTOR_PROSHOT1000_BUFFER_SIZE * MAX_SUPPORTED_MOTOR_PORTS];
...
// <slack> = 10%
// (30 + 26 + 3) / 0.44 = 134
#define BBSHOT_PORT_INPUT_BUFFER_LENGTH 134
extern uint16_t bbInputBuffer[BBSHOT_PORT_INPUT_BUFFER_LENGTH * MAX_SUPPORTED_MOTOR_PORTS];

uint32_t getDshotBaseFrequency(motorPwmProtocolTypes_e pwmProtocolType);
void bbGpioSetup(bbMotor_t *bbMotor);
void bbTimebaseSetup(bbPort_t *bbPort, motorPwmProtocolTypes_e pwmProtocolType);
