...
typedef struct pidProfile_s {
    ...
    uint8_t dterm_cut_gyro_gain;            // Gain factor for amount of gyro activity required to remove the dterm cut
    uint8_t dterm_cut_setpoint_gain;        // Gain factor for amount of setpoint activity required to remove the dterm cut
