...
#if defined (KAKUTEF4V2)
#define USABLE_TIMER_CHANNEL_COUNT (6 + BBSHOT_PACER_COUNT)
#define USED_TIMERS (( TIM_N(2) | TIM_N(3) |  TIM_N(8)) | BBSHOT_PACER_TIMERS))
#elif defined(FLYWOOF405)
#define USABLE_TIMER_CHANNEL_COUNT (11 + BBSHOT_PACER_COUNT)
#define USED_TIMERS (( TIM_N(2) | TIM_N(3) | TIM_N(4)|  TIM_N(8)) | BBSHOT_PACER_TIMERS))
#else
#define USABLE_TIMER_CHANNEL_COUNT (8 + BBSHOT_PACER_COUNT)
#define USED_TIMERS (( TIM_N(2) | TIM_N(3) | TIM_N(5)  |  TIM_N(8)) | BBSHOT_PACER_TIMERS))
#endif
