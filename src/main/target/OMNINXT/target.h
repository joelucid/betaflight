...
#define USABLE_TIMER_CHANNEL_COUNT ((21 + BBSHOT_PACER_COUNT) + BBSHOT_PACER_COUNT)
#define USED_TIMERS ((( TIM_N(1) | TIM_N(2) | TIM_N(3) | TIM_N(4) | TIM_N(5) | TIM_N(8) | TIM_N(9) | TIM_N(10) | TIM_N(11) | TIM_N(12)) | BBSHOT_PACER_TIMERS)) | BBSHOT_PACER_TIMERS))
