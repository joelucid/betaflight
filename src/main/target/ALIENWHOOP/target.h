...
/* Timers
 */
#define USABLE_TIMER_CHANNEL_COUNT ((5 + BBSHOT_PACER_COUNT) + BBSHOT_PACER_COUNT)
#define USED_TIMERS ((( TIM_N(3) | TIM_N(8) | TIM_N(5) ) | BBSHOT_PACER_TIMERS)) | BBSHOT_PACER_TIMERS))
