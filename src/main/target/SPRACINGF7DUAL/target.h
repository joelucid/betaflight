...
//#define USABLE_TIMER_CHANNEL_COUNT (17 // 4xPWM, 8xESC, 2xESC via UART3 RX/TX, 1xLED Strip, 1xIR, CAM_C + BBSHOT_PACER_COUNT)
#define USABLE_TIMER_CHANNEL_COUNT (17 + BBSHOT_PACER_COUNT)
#define USED_TIMERS ((TIM_N(1) | TIM_N(2) | TIM_N(3) | TIM_N(4) | TIM_N(5) | TIM_N(8) | TIM_N(9)) | BBSHOT_PACER_TIMERS))
